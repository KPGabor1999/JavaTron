...
public class GameWindow extends JFrame {
    ...
    public GameWindow() {
        ...
        setJMenuBar(menuBar);
        JMenu startGame = new JMenu("Játék");
        JMenuItem start = new JMenuItem("Játék indítása");
        startGame.add(start);
        menuBar.add(startGame);
        JMenu other = new JMenu("Egyéb");
        JMenuItem showLeaderBoard = new JMenuItem("Dicsőségtábla");
        other.add(showLeaderBoard);
        JMenuItem aboutMe = new JMenuItem("Stáblista");
        other.add(aboutMe);
        menuBar.add(other);
    ...
    public void showLeaderBoard() {
        LeaderBoard leaderboard = new LeaderBoard(this, "Dicsőségtábla");
        leaderboard.setVisible(true);
    }
    
    private void developerMessage(){
        JDialog messageWindow = new JDialog(this, "Stáblista");
        JPanel messagePanel = new JPanel();
        JLabel developerMessage = new JLabel();
        developerMessage.setText("Fejlesztette: Korom Pál Gábor (korompalgabor.webnode.hu)");
        messagePanel.add(developerMessage);
        messageWindow.add(messagePanel);
        messageWindow.setSize(360, 70);
