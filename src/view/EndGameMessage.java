...
public class EndGameMessage extends JDialog {
    ...
    public EndGameMessage(Frame owner, Player player1, Player player2) {
        ...
        if (player1.isAlive() && !player2.isAlive()) {
            this.winner = PLAYER1;
            winnerAnnouncement.setText("1. játékos győzött!");
        } else if (!player1.isAlive() && player2.isAlive()) {
            this.winner = PLAYER2;
            winnerAnnouncement.setText("2. játékos győzött!");
        } else {
            this.winner = EVEN;
            winnerAnnouncement.setText("A meccs döntetlen!");
        }
        ...
        //Visszavágó gomb:
        JButton RematchButton = new JButton("Visszavágó");
